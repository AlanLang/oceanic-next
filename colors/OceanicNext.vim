...
" {{{ call s::hi(group, fg, bg, gui, guisp)
  ...
  call s:hi('Substitute',                         s:red,    s:cyan, '',          '')
  ...
  call s:hi('DiffText',                          s:blue,   s:red, '',          '')
  call s:hi('DiffAdded',                         s:base07, s:base01,  s:bold,      '')
  call s:hi('DiffFile',                          s:red,    s:base01, '',          '')
  call s:hi('DiffNewFile',                       s:green,  s:base01, '',          '')
  call s:hi('DiffLine',                          s:blue,   s:base01, '',          '')
